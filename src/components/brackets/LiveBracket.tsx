            ...
            try {
                ...
                for (let i = 0; i < response.data.length; i++) {
                    ...
                    switch (response.data[i].bracket_name) {
                        ...
                        case gameSB: isMounted && setAfcSBScore(game.home_team_score); isMounted && setNfcSBScore(game.away_team_score); isMounted && setAfcSB(game.home_team); isMounted && setNfcSB(game.away_team); isMounted && setFss(game.away_team_score + game.home_team_score); if (response.data[i].winner != "") { isMounted && setSBWinner(game.winner); } break;
                    }
                }
