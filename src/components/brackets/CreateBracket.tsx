...
export default function Bracket() {
    ...
    const nfcDR1Control = { value: nfcDR1Winner, onChange: handleNfcDR1Change, exclusive: true, disabled: false };
    const nfcDR2Control = { value: nfcDR2Winner, onChange: handleNfcDR2Change, exclusive: true, disabled: false };
    const afcCCControl = { value: afcCCWinner, onChange: handleAfcCCChange, exclusive: true, disabled: false };
    const nfcCCControl = { value: nfcCCWinner, onChange: handleNfcCCChange, exclusive: true, disabled: false };
    const sbControl = { value: sbWinner, onChange: handleSBChange, exclusive: true, disabled: false };
    const fssControl = { disabled: false, onChange: handleFss };
